...
#include "ui_oss_form_general.h"
#include "components/message_dialog.h"
#include <QDebug>
namespace ady{

OSSFormGeneral::OSSFormGeneral(QWidget* parent)
    :FormPanel(parent),
    ui(new Ui::OSSFormGeneralUI)
{
...
void OSSFormGeneral::initFormData(SiteRecord record)
{
...
bool OSSFormGeneral::validateFormData(SiteRecord& record)
{
    //bool ret = true;
