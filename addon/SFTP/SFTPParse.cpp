...
bool SFTPParse::lineParse(QString& line,FileItem& entry)
{
...
bool SFTPParse::parseAsUnix(QString &line, FileItem& entry)
{
...
/*bool SFTPParse::parseAsMlsd(QString &line, FileItem& entry)
{
...
bool SFTPParse::parseAsDos(QString &line, FileItem &entry)
{
...
bool SFTPParse::parseShortDate(QString &date,QString &time,FileItem &entry)
{
    if(date.isEmpty()){
            return false;
    }
