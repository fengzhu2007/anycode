...
#include <QDebug>
namespace ady {
    NetworkRequest::NetworkRequest(CURL *curl)
    {
        this->curl = curl;
        this->connected = true;
    }
    ...
    void NetworkRequest::setUsername(QString username){this->username = username;}
    void NetworkRequest::setPassword(QString password){this->password = password;}
    void NetworkRequest::setPort(int port){this->port = port;}
    void NetworkRequest::setHost(QString host){this->host = host;}
    ...
    NetworkResponse* NetworkRequest::listDir(QString dir,int page,int pageSize)
    {
        Q_UNUSED(dir);
        Q_UNUSED(page);
        Q_UNUSED(pageSize);
    ...
    NetworkResponse* NetworkRequest::tinyListDir(QString dir)
    {
        Q_UNUSED(dir);
        return nullptr;
    }
